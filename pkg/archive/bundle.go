...
// BuildContext identifies the images and bundle group supplied by the CI orchestrator.
type BuildContext struct {
	BuildGroupID    string   `json:"buildGroupId,omitempty"`
	ImageName       string   `json:"imageName,omitempty"`
	BuildImageNames []string `json:"buildImageNames,omitempty"`
}
...
func GetContext() (*GitContext, error) {
	...
	gitFileStatuses := make([]GitFileStatus, 0)
...
func (b *Bundle) SetBuildContext(context *BuildContext) {
	b.manifest.Build = context
}
